...
<!--
 ...
 -->    
    <script type="text/javascript" src="js/deviceatlas-1.1.min.js"></script>
    ...
    <div id="contents">
      ...
      <div id="image-container">
        ...
        <p>
          ...
          high resulations it may not be a pleasant experience for the user so lets
          use the properties...
        </p>
        <?php
          $width = isset($properties['usableDisplayWidth'])?
              $properties['usableDisplayWidth']: 0;
          $imageSize = 'small';
          if ($width > 900) {
              $imageSize = 'large';
          } elseif ($width > 500) {
